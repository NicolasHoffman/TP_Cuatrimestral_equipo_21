<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmUsuario.aspx.cs" Inherits="TPCuatrimestral_Equipo21.FrmUsuario" %>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="txtNombreUsu" class="form-label">Nombre Usuario:</label>
                            <asp:TextBox ID="txtNombreUsu" runat="server" CssClass="form-control" required placeholder="Ingrese Nombre de Usuario"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                            <label for="ddlTipoUsaurio" class="form-label">Tipo Usuario</label>
